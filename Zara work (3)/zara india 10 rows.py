...
"""
Extract discount badge shown on the page, e.g. "-80 %".
Returns a string like "-80" (without %), or None.
"""
...
"""
Tries to open the "COMPOSITION, CARE & ORIGIN" section/panel.
Returns True if it *likely* opened, else False.
"""
candidates = [
...
Also produces price_current_usd for ALL items, and sale_price_usd only when on_sale.
"""
...
print(" materials_text:", (materials_text[:180] + "...") if materials_text and len(materials_text) > 180 else materials_text)
